...
Se nenhum simulador `iPhone 17` existir, liste os disponíveis com `xcrun simctl list devices available` e use um nome da lista.
...
Run: `cd App && xcodebuild -project Casal.xcodeproj -scheme Casal -destination 'platform=iOS Simulator,name=iPhone 17' build`
Expected: `BUILD SUCCEEDED`
