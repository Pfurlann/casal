    ...
    <div>
      ...
      <div className="px-4 pt-6 lg:px-0 lg:pt-8">
        <p className="text-[12px] text-cinza">
          diagnóstico · {MESES[(d.competencia.mes ?? 1) - 1]}
        </p>
        ...
        <div className="casal-paineis mt-6 lg:mt-8">
          ...
          <section className="casal-painel casal-painel-4 mt-8 lg:mt-0">
          ...
          <section className="casal-painel casal-painel-8 mt-8 lg:mt-0">
          ...
          <section className="casal-painel casal-painel-12 mt-8 pb-4 lg:mt-0 lg:pb-0">
            <Rotulo>metas</Rotulo>
            {d.metas.length === 0 ? (
